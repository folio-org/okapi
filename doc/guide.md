...
<!-- Regenerate this as needed by running `./md2toc guide.md` and including its output here -->
* [Okapi Guide and Reference](#okapi-guide-and-reference)
    ...
    * [Architecture](#architecture)
        * [Okapi's own Web Services](#okapis-own-web-services)
            ...
            * [Core Okapi Web Service Authentication and Authorization](#core-okapi-web-service-authentication-and-authorization)
    ...
    * [Storage](#storage)
        * [Example modules](#example-modules)
            * [Okapi-sample-module](#okapi-sample-module)
            * [Okapi-auth-module](#okapi-auth-module)
        * [Running Okapi itself](#running-okapi-itself)
        * [Deploying Modules](#deploying-modules)
            * [Deploying the sample module](#deploying-the-sample-module)
            * [Adding the sample module to the discovery](#adding-the-sample-module-to-the-discovery)
            * [Telling the proxy about the module](#telling-the-proxy-about-the-module)
            * [Deploying the auth module](#deploying-the-auth-module)
