...
public class SemVerTest {
  ...
  public void test() {
    ...
    assertEquals("versions: 1", v1.toString());

    SemVer v2 = new SemVer("2");
    assertEquals("versions: 2", v2.toString());
    ...
    assertEquals("versions: 1 2", v1_2.toString());
    ...
    assertEquals("versions: 1 5 0", v1_5.toString());
    SemVer v1_10 = new SemVer("1.10.0");
    assertEquals("versions: 1 10 0", v1_10.toString());
    assertEquals(v1_10.compareTo(v1_5), 2);
    assertEquals(v1_5.compareTo(v1_10), -2);

    SemVer p1 = new SemVer("1.0.0-alpha");
    assertEquals("versions: 1 0 0 pre: alpha", p1.toString());
    SemVer p2 = new SemVer("1.0.0-alpha.1");
    assertEquals("versions: 1 0 0 pre: alpha 1", p2.toString());
    SemVer p3 = new SemVer("1.0.0-alpha.beta");
    assertEquals("versions: 1 0 0 pre: alpha beta", p3.toString());
    SemVer p4 = new SemVer("1.0.0-beta");
    assertEquals("versions: 1 0 0 pre: beta", p4.toString());
    SemVer p5 = new SemVer("1.0.0-beta.2");
    assertEquals("versions: 1 0 0 pre: beta 2", p5.toString());
    SemVer p6 = new SemVer("1.0.0-beta.11");
    assertEquals("versions: 1 0 0 pre: beta 11", p6.toString());
    SemVer p7 = new SemVer("1.0.0-rc.1");
    assertEquals("versions: 1 0 0 pre: rc 1", p7.toString());
    SemVer p8 = new SemVer("1.0.0");
    assertEquals("versions: 1 0 0", p8.toString());
    ...
    assertEquals("versions: 1 0 0 pre: rc 1 metadata: snapshot-2017.1", snap1.toString());

    SemVer snap2 = new SemVer("1.0.0-rc.1+snapshot-2017.2");
    assertEquals("versions: 1 0 0 pre: rc 1 metadata: snapshot-2017.2", snap2.toString());

    SemVer snap3 = new SemVer("1.0.0+snapshot-2017.2");
    assertEquals("versions: 1 0 0 metadata: snapshot-2017.2", snap3.toString());
