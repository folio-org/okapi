...
public class DiscoveryManager implements NodeListener {
   ...
   *   <li>NodeId, but no LaunchDescriptor: Fetch the module, use its LaunchDescriptor, and deploy.</li>
   *   <li>No nodeId: Do not deploy at all, just record the existence (URL and instId) of the module</li>
   *   <ol>
   */
